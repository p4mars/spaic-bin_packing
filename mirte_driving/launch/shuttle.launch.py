...
This is the assembly file: it starts every node of mirte_driving_3 plus the
...
SIM (default):   ros2 launch mirte_driving_3 shuttle.launch.py
REAL ROBOT:      normally just use mission.launch.py (sets all of the below for
    ...
    ros2 launch mirte_driving_3 shuttle.launch.py \
...
def generate_launch_description():
    ...
    nav_params = PathJoinSubstitution([
        FindPackageShare('mirte_driving_3'), 'params', 'exploration_nav2_params.yaml'])
    slam_params = PathJoinSubstitution([
        FindPackageShare('mirte_driving_3'), 'params', 'slam_params.yaml'])
    bt_xml = PathJoinSubstitution([
        FindPackageShare('mirte_driving_3'), 'trees', 'nav2_minimal_tree.xml'])
    ...
    return LaunchDescription(args + [
        ...
        SetEnvironmentVariable(
            ...
            value=PathJoinSubstitution([FindPackageShare('mirte_driving_3'),
        ...
        Node(package='mirte_driving_3', executable='scan_filter.py',
        ...
        Node(package='mirte_driving_3', executable='zone_detector.py',
        ...
        TimerAction(period=50.0, actions=[
            Node(package='mirte_driving_3', executable='shuttle_manager.py',
