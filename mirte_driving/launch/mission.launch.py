...
configured purely via params/remaps.
    ...
    ros2 launch mirte_driving_3 mission.launch.py run_zone_detector:=false
"""
...
def generate_launch_description():
    ...
    shuttle = PathJoinSubstitution([
        FindPackageShare('mirte_driving_3'), 'launch', 'shuttle.launch.py'])

    return LaunchDescription([
        # false = detection OFFLOADED to the laptop: run
        #         `ros2 launch mirte_driving_3 detector.launch.py` there and the
